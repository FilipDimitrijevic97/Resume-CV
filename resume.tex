...
\def\phone{+46 073 91 17 70}
\def\city{Stockholm}
\def\email{filipdi@kth.se}
% blog edited in _header.tex
\def\github{github} % FilipDimitrijevic97
\def\LinkedIn{linkedin} % linkedin.com/in/filip-dimitrijevic-6b0543215/
